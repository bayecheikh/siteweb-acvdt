...
- `<OffreEncours>` | `<offre-encours>` (components/OffreEncours.vue)
...
- `<StatistiqueOffres>` | `<statistique-offres>` (components/StatistiqueOffres.vue)
- `<TableOffres>` | `<table-offres>` (components/TableOffres.vue)
